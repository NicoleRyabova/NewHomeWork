...
public class FruitBase implements Serializable {
    ...
    public void exportCatalogue(String path) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.setVisibility(objectMapper.getVisibilityChecker().withFieldVisibility(JsonAutoDetect.Visibility.ANY));
        objectMapper.writeValue(new File(path), fruitCatalogue);
    }
    ...
    public void importCatalogue(String path) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.setVisibility(objectMapper.getVisibilityChecker().withFieldVisibility(JsonAutoDetect.Visibility.ANY));
        fruitCatalogue = objectMapper.readValue(new File(path), FruitCatalogue.class);
